...
public final class HeaderBinding implements ViewBinding {
  ...
  @NonNull
  public final TextView nepal;

  @NonNull
  public final TextView textView2;

  private HeaderBinding(@NonNull ConstraintLayout rootView, @NonNull TextView nepal,
  ...
  public static HeaderBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      id = R.id.nepal;
      TextView nepal = ViewBindings.findChildViewById(rootView, id);
      if (nepal == null) {
        break missingId;
      }
      ...
      return new HeaderBinding((ConstraintLayout) rootView, nepal, textView2);
    }
